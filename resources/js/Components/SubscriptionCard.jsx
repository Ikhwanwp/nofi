...
export default function SubscriptionCard({id, name, price, durationMonth, features, isPremium, onSelectSubscription}) {
  return (
    <>
    {/* Basic */}
    {!isPremium && (
        ...
        <div>
            ...
            <p className="text-gray-1 text-xs font-light">/{durationMonth} months</p>
        </div>
        ...
        <div onClick={onSelectSubscription}>
            <PrimaryButton children={`Start ${name}`} variant='white-outline' type='button' className=''/>
        </div>
        </div>
    )}
    {/* Premium */}
    {isPremium && (
        ...
        <div>
            ...
            <p className="text-[#767676] text-xs font-light">/{durationMonth} months</p>
        </div>
        ...
        {/* <!-- Bottom: CTA Button --> */}
        <div onClick={onSelectSubscription}>
            <PrimaryButton children='Subscribe Now' variant='primary' type='button'/>
        </div>
        </div>
    )}
    </>
