...
export default function SubscriptionPlanDetail({name, isPremium, remainingActiveDays, activeDays}) {
    // RemainingDays -> Berapa Lama
    ...
    <div className="p-5 bg-black rounded-[25px]">
        ...
        <div className={`
            rounded-full h-full bg-alerange ${loadingProgress()}
        `}></div>
        </div>
    </div>
</div>
